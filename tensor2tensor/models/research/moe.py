...
def dynamic_experts(inputs, combine_tensor, experts_dim, hidden_dim, output_dim, name=None):
  ...
  op = DynamicExpertsOperation(inputs, combine_tensor, experts_dim, hidden_dim, output_dim, name)
  return op.outputs[0]
